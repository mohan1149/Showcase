...
<body>
    ...
    <div class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        <div class="w3-display-left w3-text-white" style="padding:48px">
            <span class="w3-jumbo w3-hide-small">{{__('t.website_heading')}}</span><br>
            ...
            <div class="w3-row-padding">
                <div class="w3-col m6">
                    ...
                    <h5 class="w3-margin">Welcome to Sahas Systems. We are a team of young and adventurous developers, focused on building mobile and web applications with cutting edge technologies.
                        We are specialized in developing custom software solutions, cloud services, content management systems and e-commerce applications. We provide the Web, Email and Domain Hosting services at offardable prices.
        ...
        <div class="w3-container w3-light-grey" style="padding: 70px 15px">
            <div class="w3-row">
                ...
                <div class="w3-col l5">
                    ...
                    <h4>We believe in Techonology and innovation.</h4>
                </div>
            </div>
        </div>
    </section>
