...
<style>
	...
	h1,h2,h3,h4,h5,h6,p,pre,span,a{
...
<body>
			...
			<div class="container"><a href="#" class="navbar-brand text-uppercase font-weight-bold">
				...
				<div id="navbarSupportedContent" class="collapse navbar-collapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a href="#about-us" class="nav-link text-uppercase font-weight-bold">About</a></li>
    ...
    <div class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        <div class="w3-display-left w3-text-white" style="padding:48px">
            <span class="w3-jumbo w3-hide-small">Build something that matters.</span><br>
            <span class="w3-xxlarge w3-hide-large w3-hide-medium">Build something that matters</span><br>
            <span class="w3-large">You are at the right place at the right time. Let's work together to build the future of your business.</span>
            <p>
        ...
        <div class="w3-display-bottomleft w3-text-grey w3-large" style="padding:24px 48px">
            ...
            <i class="fa fa-linkedin w3-hover-opacity w3-text-white"></i>
        </div>
    </div>

    <!-- About-us Section -->
    <div id="about-us" class="w3-container" style="padding:120px 16px">
        <div class="w3-row-padding">
            <div class="w3-col m6">
                <h2 class="">Who we are..?</h2>
                <h5 class="w3-margin">Welcome to Sahas Systems. We are a team of young and adventurous developers, focused on building mobile and web applications with cutting edge technologies.
					We are specialized in developing custom software solutions, cloud services, content management systems and e-commerce applications.
	...
	{{-- Why us Section --}}
	<div id="about-us" class="w3-container w3-light-grey" style="padding:120px 16px">
        <div class="w3-row-padding">
			<div class="w3-col m6">
				<img src="/assets/images/why_us.svg" width="100%" alt="about">
            </div>
            <div class="w3-col m6">
                <h2 class="">Why Us..?</h2>
                <h5 class="w3-margin">Welcome to Sahas Systems. We are a team of young and adventurous developers, focused on building mobile and web applications with cutting edge technologies.
    ...
    {{-- <div class="w3-container w3-light-grey w3-padding-64">
        <div class="w3-row-padding">
            <div class="w3-col m6 w3-hide-small">
                <svg class="deer" xmlns="http://www.w3.org/2000/svg" width="700" height="600" viewBox="0 0 700 600">
	...
	<footer class="w3-container w3-black">
		<div class="w3-center w3-padding w3-margin">
			<h5>Sahas Systems || All Rights Reserved || {{date('Y')}}</h5>
		</div>
	</footer>
    <script>
        $(function () {
